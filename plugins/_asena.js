...
if (Config.WORKTYPE == 'private') {
    ...
    Asena.addCommand({pattern: 'kp ?(.*)', fromMe: true, dontAddCommandList: true}, (async (message, match) => {
        ...
        if (match[1] === '') {
            ...
            await message.client.sendMessage(
                message.jid,'●▬▬▬ *Katil Piçlerin Hizmetinde* ▬▬▬●\n\n' + CMD_HELP, MessageType.text
            );    
        } else {
    ...
    Asena.addCommand({pattern: 'kp ?(.*)', fromMe: false, dontAddCommandList: true}, (async (message, match) => {
        ...
        if (match[1] === '') {
            ...
            if (CMD_HELP === '') CMD_HELP += Lang.NOT_FOUND;
            await message.client.sendMessage(
                message.jid,'●▬▬▬ *Katil Piçlerin Hizmetlerin* ▬▬▬●\n\n' + CMD_HELP, MessageType.text
            );
        }
    }));
}
