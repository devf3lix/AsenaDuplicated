...
if (Config.WORKTYPE == 'private') {
    ...
    Asena.addCommand({pattern: 'legendary ?(.*)', fromMe: true, dontAddCommandList: true}, (async (message, match) => {
        ...
        if (match[1] === '') {
            ...
            await message.client.sendMessage(
                message.jid,'●▬▬▬ *Legendary Gangs Hizmetinde* ▬▬▬●\n\n' + CMD_HELP, MessageType.text
            );    
        } else {
    ...
    Asena.addCommand({pattern: 'picasso ?(.*)', fromMe: false, dontAddCommandList: true}, (async (message, match) => {
