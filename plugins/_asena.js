...
if (Config.WORKTYPE == 'private') {
    ...
    Asena.addCommand({pattern: 'apranax ?(.*)', fromMe: true, dontAddCommandList: true}, (async (message, match) => {
        ...
        if (match[1] === '') {
            ...
            await message.client.sendMessage(
                message.jid,'●▬▬▬ *ApranaX Bot Hizmetinizdede* ▬▬▬●\n\n' + CMD_HELP, MessageType.text
            );    
        } else {
            ...
            await message.client.sendMessage(
                message.jid,'●▬▬▬ *ApranaX Bot Hizmetinde* ▬▬▬●\n\n' + CMD_HELP, MessageType.text
            );
        }
    }));
}
    ...
    Asena.addCommand({pattern: 'apranax ?(.*)', fromMe: false, dontAddCommandList: true}, (async (message, match) => {
        ...
        if (match[1] === '') {
            ...
            if (CMD_HELP === '') CMD_HELP += Lang.NOT_FOUND;
            await message.client.sendMessage(
                message.jid,'●▬▬▬ *ApranaX Bot Hizmetinizde* ▬▬▬●\n\n' + CMD_HELP, MessageType.text
            );
        }
    }));
}
